...
const watchFile = ({
  ...
  if (!packagePath) {
    console.error(
      "Cannot find package.json. Travelling up from current working directory"
    );
  }
  ...
  if (
    ...
    console.log("package-lock.json has been modified.");
  ...
  console.log("package-lock.json has not been modified.");
  return false;
};
